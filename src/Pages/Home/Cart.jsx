  ...
  return (
    <div className="bg-white shadow-lg p-2 flex flex-col justify-between">
      ...
      <ul className="mt-1 space-y-1">
        ...
        <li><h4 className="text-[9px] sm:text-[9px] md:text-[9px] lg:text-[9px] xl:text-[10px] 2xl:text-[10px] text-gray-400 font-bold">{item.details.slice(0,22)}</h4></li>
        <li><input type="number" className="w-full border-[1px] border-gray-200 focus:outline-none" onChange={() => quantityData(event.target.value)}></input></li>
