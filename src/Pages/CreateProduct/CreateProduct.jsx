    ...
    <Title name={'Create-Product'}></Title>
      ...
      <div className="container mx-auto sm:flex sm:flex-col items-center h-full md:h-screen px-5 mt-5 md:mt-3 lg:mt-5 xl:mt-6 2xl:mt-8 gap-5">
        ...
        <div className="w-[58%] sm:w-[32%] md:w-[23%] lg:w-[21%] xl:w-[20%] 2xl:w-[20%] mx-auto">
            <h3 className="font-bold text-xl sm:text-2xl md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-center border-b-2 border-b-red-500 text-red-500">Create-Product</h3>
          </div>
          {/* form title end */}
        {/* form start */}
        <div className="card bg-base-100 w-full sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-7/12 shrink-0 shadow-2xl">
      <form onSubmit={createProduct} className="p-3">
        <div className="flex flex-col sm:flex-row justify-between gap-1 sm:gap-3">
          ...
          <div className="form-control w-full">
            ...
            <input type="text" name="price" placeholder="enter product price" className="input input-bordered input-sm md:input-md" required />
          </div>
        </div>
        <div className="form-control w-full">
            <label className="label">
            ...
            <input type="file" name="image" className="file-input w-full file-input-bordered file-input-sm md:file-input-md" required/>
        </div>
        <div className="form-control w-full">
            <label className="label">
