    ...
    <>
      ...
      <div className="bg-black bg-opacity-90 h-full flex flex-col justify-around items-center ">
        ...
        <ul className="flex flex-col gap-2 md:gap-3">
          <li>
            {
              active ? <NavLink className={({ isActive }) => isActive ? "sm:text-[8px] md:text-[10px] lg:text-xs xl:text-sm 2xl:text-sm font-bold text-green-500": "sm:text-[8px] md:text-[10px] lg:text-xs xl:text-sm 2xl:text-sm text-white"} to="/">Home</NavLink> : <NavLink className={({ isActive }) => isActive ? " text-green-500": " text-white"} to="/"><MdDashboard className="text-xl xl:text-3xl mx-auto"></MdDashboard></NavLink>
            }
          </li>
          {
        ...
        <div onClick={logOutFun}>
          {
            active ? <button className="sm:text-[8px] md:text-[10px] lg:text-xs xl:text-sm 2xl:text-sm font-bold text-green-500">LogOut</button> : <IoLogOut className="text-2xl xl:text-3xl mx-auto text-green-500"></IoLogOut>
          }
